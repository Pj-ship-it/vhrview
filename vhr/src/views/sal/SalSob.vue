  ...
  <div>
    ...
    <el-dialog
      ...
      <div style="display: flex;justify-content: space-around;align-items: center">
        ...
        <el-input v-model="salary[index]" :placeholder="'请输入'+salaryItemName[index]+'...'"
    ...
    data() {
      return {
        ...
        salary: {
          ...
          bonus: undefined,
          pensionPer: undefined,
          pensionBase: undefined,
          medicalPer: undefined,
          medicalBase: undefined,
          accumulationFundPer: undefined,
          accumulationFundBase: undefined,
          name: undefined
        }
      }
    },
